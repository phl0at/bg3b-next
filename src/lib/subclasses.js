const SubClasses = [
  ...
  {
    class: 3,
    description: 'A domain shared by wicked, chaotic, and mischievous deities alike, those who channel Trickery specialize in deception and illusion magic.',
    id: 6,
    level: 1,
  ...
  {
    class: 10,
    description: 'Your powers come from ancient forces of chaos. They churn withing you - waiting to burst free at any time.',
    id: 10,
    level: 1,
    name: 'Wild Magic'
  },
  ...
  {
    class: 11,
    description: 'Warlocks bound to eldritch beings in the Far Realms work towards inscrutable goals, gaining strange powers over entropy and the mind.',
    id: 13,
    level: 1,
  ...
  {
    class: 4,
    description: 'The Circle of the Land Subclass has a heavy focus on the use of Nature Magic, and allows the Druid to regain some Spells after a Short Rest.',
    id: 18,
    level: 2,
  ...
  {
    class: 4,
    description: "The Circle of the Moon Subclass has a much heavier focus on the Wild Shape Class Feature of the Druid. If you like shapeshifting, and want to do so more effectively then you'll likely enjoy this Subclass.",
    id: 19,
    level: 2,
  ...
  {
    class: 12,
    description: 'Evocation spells focus elemental energy into powerful attacks and enchantments. Those who specialize in this school are known as evokers.',
    id: 25,
    level: 2,
    name: 'Evocation'
  },
  ...
  {
    class: 5,
    description: 'You approach the complex problems posed by combat with one distinctively effective solution - you hit those problems, really quite hard.',
    id: 30,
    level: 3,
    name: 'Champion'
  },
  ...
  {
    class: 6,
    description: "These monks 'bend' the four elements at will, becoming 'avatars' of balance.",
    id: 33,
    level: 3,
  ...
  {
    class: 8,
    description: 'Hunters seek the most dangerous prey in Faerun, from ancient dragons to massive hordes of undead, and excel at slaying them all.',
    id: 43,
    level: 3,
    name: 'Hunter'
  },
  {
    class: 9,
    description: 'Arcane Tricksters are rogues with a clever touch of magic, using illusions and enchantments to keep their opponents on the backfoot.',
    id: 44,
    level: 3,
