/*
  ...
  - Made the column `meleeOH` on table `Build` required. This step will fail if there are existing NULL values in that column.
  - Made the column `rangedOH` on table `Build` required. This step will fail if there are existing NULL values in that column.
