/*
  ...
  - You are about to drop the column `subClassName` on the `Class` table. All the data in the column will be lost.
  - Added the required column `subClassId` to the `Class` table without a default value. This is not possible if the table is not empty.
